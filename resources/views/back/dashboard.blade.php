...
@section('content')
    ...
    <div class="row g-4 justify-content-center align-items-center mt-4">
            ...
            <div class="card shadow h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-grid mt-auto">
                        <a href="{{ route('blogs.index') }}" class="btn btn-primary btn-lg">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow h-100">
                <div class="img-container" style="height: 200px; overflow: hidden;">
                    <img src="{{ asset('img/page.jpg') }}" class="card-img-top" style="object-fit: cover;"
                        alt="Halaman Blog">
                </div>
                <div class="card-body d-flex flex-column">
                    <h3 class="card-title text-center">Page</h3>
                    <div class="d-grid mt-auto">
                        <a href="{{ route('posts.index') }}" class="btn btn-primary btn-lg">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-grid mt-auto">
                        <a href="{{ route('users.index') }}" class="btn btn-primary btn-lg">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
